...
namespace RandomVectorMap.Mapping
{
    ...
    public struct Vector
    {
        ...
        {
            return new Vector(-DeltaY, DeltaX);
        }
        ...
        {
            return new Vector(vector1.DeltaX + vector2.DeltaX, vector1.DeltaY + vector2.DeltaY);
        }
        ...
        {
            return new Vector(terminus.DeltaX - origin.DeltaX, terminus.DeltaY - origin.DeltaY);
        }
        ...
        {
            return new Vector((int)(vector.DeltaX * ratio), (int)(vector.DeltaY * ratio));
        }
