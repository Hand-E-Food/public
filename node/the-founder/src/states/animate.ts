...
export class Animate {
   ...
   */
  public static async fadeIn(element: HTMLElement, duration: number = Animate.defaultDuration): Promise<void> {
   ...
   */
  public static async fadeOut(element: HTMLElement, duration: number = Animate.defaultDuration): Promise<void> {
   ...
   */
  public static async glow(element: HTMLElement, duration: number = Animate.defaultDuration): Promise<void> {
   ...
   */
  public static pause(milliseconds: number = Animate.defaultDuration): Promise<void> {
