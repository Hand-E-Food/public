    ...
    public constructor(characterName: string) {
        this.phaseInstructions = {
            [StoryPhase.Exposition]: [
                ...
                'provides exposition for the main character' ],
            [StoryPhase.RisingAction]: [
            ...
            [StoryPhase.Failure]: [
                'is confusing and does not fit the story'],
        };
    }

    /**
     * Gets an appropriate instruction for the current phase of the story that fits the prompt "Write a paragraph that `instruction`.".
