...
export class Primitive {
   ...
   */
  public static async fadeIn(element: HTMLElement, duration: number = DefaultDuration): Promise<void> {
   ...
   */
  public static async fadeOut(element: HTMLElement, duration: number = DefaultDuration): Promise<void> {
   ...
   */
  public static async glow(element: HTMLElement, duration: number = DefaultDuration): Promise<void> {
