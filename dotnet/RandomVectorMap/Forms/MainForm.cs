...
namespace RandomVectorMap.Forms
{
    ...
    public partial class MainForm : Form
    {
        ...
        private void MoveView(double deltaX, double deltaY)
        {
            ...
            MapView.CenterPoint = MapView.CenterPoint + new Size((int)(deltaX * scroll), (int)(deltaY * scroll));
        }
        ...
        private void Reset()
        {
            ...
            int seed;
            if (!int.TryParse(ReseedTextBox.Text, out seed))
            {
        ...
        public void ZoomFit()
        {
            ...
            MapView.CenterPoint = new Point(0, 0);
